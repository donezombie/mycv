    ...
    return (
      <div className="background-header d-flex justify-content-center align-items-center">
        <div className="text-light d-flex flex-column align-items-center">
          <a href="https://facebook.com/donezombiee" target="_blank"><img className="animated fadeIn" id="avatar" src={imgAvatar} /></a>
        ...
        <div id="footerImg" className="d-flex justify-content-center text-light">dasdasd</div>
      </div>
    );
  }
}
