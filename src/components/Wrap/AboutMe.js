          ...
          <div className="col-md-8 border border-0 shadow p-3 ">
                <div className="row">
                    <div className="col-md-6">
                        <h3 className="pb-3 font-weight-bold">About Me</h3>
                        <p>Hi guys! I'm a Front-end Web Developer.</p>
                    </div>
                    <div className="col-md-6">
                      <h3 className="pb-3 font-weight-bold" style={{visibility: "hidden"}}>Profile</h3>
                      <div className="d-flex justify-content-center"> 
                        ...
                        <div className="col-md-8">
                          ...
                          <p>Coffe, Coding, PlayGame, Look at a Beautiful Girl </p>
                        </div>
                      </div>
                    </div>
                </div>
